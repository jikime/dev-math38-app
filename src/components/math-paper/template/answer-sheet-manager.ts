class AnswerSheetManager {
  ...
  _addAnswerSheet() {
    ...
    answerSheet.classList.add("page");
    ...
    divider.className = "w-full h-[6px] flex"
    divider.innerHTML=`
    ...
    bodyColumn.className = "column-all";
    body.appendChild(bodyColumn);
    const sub1 = document.createElement('div');
    sub1.className='problem-answer-summary';
    bodyColumn.appendChild(sub1);
    const sub2 = document.createElement('div');
    sub2.className='problem-answers-block';
...
export default AnswerSheetManager;
