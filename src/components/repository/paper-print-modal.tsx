  ...
  return (
    <div className="fixed inset-0 z-50 bg-white dark:bg-gray-900">
      ...
      <div className="h-12 bg-white dark:bg-gray-900 flex justify-between items-center border-b border-gray-200 dark:border-gray-700">
        <div className="px-8 py-4 font-bold text-base text-gray-900 dark:text-gray-100">시험지 출력하기</div>
        <button
      ...
      {/* 메인 컨텐츠 */}
      <div className="flex flex-1 gap-4 p-4 h-[calc(100vh-48px)] bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
        {/* 왼쪽: 학생 목록 */}
